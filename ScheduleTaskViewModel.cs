...
namespace UnifiVideoExporter
{
    ...
    public partial class ScheduleTaskViewModel : ObservableValidator
    {
        ...
        public ScheduleTaskViewModel(MainWindowViewModel Vm)
        {
            ...
            CurrentTaskSettings.ControllerAddress = Vm.Settings.ControllerAddress;
            CurrentTaskSettings.UserName = Vm.Settings.UserName;
            CurrentTaskSettings.Password = Vm.Settings.Password;
            CurrentTaskSettings.EndTime = Vm.Settings.EndTime;
            CurrentTaskSettings.StartTime = Vm.Settings.StartTime;
            CurrentTaskSettings.FfmpegPath = Vm.Settings.FfmpegPath;
            CurrentTaskSettings.FramesPerSecond = Vm.Settings.FramesPerSecond;
            CurrentTaskSettings.SnapshotInterval = Vm.Settings.SnapshotInterval;
            CurrentTaskSettings.SelectedCamera = Vm.Settings.SelectedCamera;
